		...
		<form action="shopping-result.html">
			<table>
				<tr>
					...
					<td class="number">
						<span id="sub" onclick="sub(${good.key.bid});">-</span><input type="text" id="number${good.key.bid}" name="number" value="${good.value}" size="2" readonly/><span id="add" onclick="add(${good.key.bid});">+</span>
					</td>
					<td class="price">
						<span >￥</span>
