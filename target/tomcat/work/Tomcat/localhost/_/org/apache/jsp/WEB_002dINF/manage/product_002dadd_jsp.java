 ...
 * Generated at: 2017-06-11 09:47:14 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t<form action=\"addBook.do\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"form\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">商品名称：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text\" name=\"bname\" value=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">商品描述：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text\" name=\"detail\" value=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">商品价格：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text tiny\" name=\"pirce\" /> 元</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text\" name=\"writer\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">出版社：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text\" name=\"printer\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">出版日期：</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Wdate\" type=\"text\" name=\"dateString\" onClick=\"WdatePicker()\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">商品图片：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"file\" class=\"text\" name=\"image\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"field\">库存：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" class=\"text tiny\" name=\"store\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/manage/product-add.jsp(68,8) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/manage/product-add.jsp(68,8) '${ bts}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${ bts}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/manage/product-add.jsp(68,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
